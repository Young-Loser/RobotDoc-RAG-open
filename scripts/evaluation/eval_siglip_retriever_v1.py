...
DOC_EMB_FILE = CACHE_DIR / "siglip_retriever_v1_doc_embeddings.pt"
DOC_META_FILE = CACHE_DIR / "siglip_retriever_v1_doc_metadata.csv"
DOC_CACHE_INFO_FILE = CACHE_DIR / "siglip_retriever_v1_doc_cache_info.json"

DETAIL_CSV = OUT_DIR / "siglip_retriever_v1_eval_details.csv"
SUMMARY_JSON = OUT_DIR / "siglip_retriever_v1_eval_summary.json"
FAILURE_CSV = OUT_DIR / "reports" / "siglip_retriever_v1_failures.csv"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate the SigLIP retriever v1.")
